...
class MinimalSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.navigator = working_on_foxy.BasicNavigatorFoxy()
        self.pose = working_on_foxy.PoseStamped()
        self.pose.pose.position.x = 17.2
        self.pose.pose.position.y = -10.4

        self.current_state = RobotState.FOLLOW_ME
        self.timer_count = time.time()

        initial_pose = working_on_foxy.PoseStamped()
